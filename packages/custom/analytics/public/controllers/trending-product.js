'use strict';
angular.module('mean.analytics').controller('TrendingProduct', ['$scope', '$http', 'Global', 'Analytics',
  function ($scope, $http, Global, Analytics) {
    ...
    $scope.tenant_usage= function(start_date,end_date) {
      $scope.mask = $http({
        method: 'GET',
        url: '/acme/trending_products?from='+start_date+'&to='+end_date+'&tz=Asia/Calcutta',
        headers: {
